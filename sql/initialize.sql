...
(NULL ,  '1',  'templatehelp',  '<p><strong>Help for creating a template</strong></p><p>There is one easy page for creating a template and this is how you do it:</p><ol><li>Template Title:&nbsp;This is the title of the template, this is how you will access and use the template.</li><li>Template Description:&nbsp;This should be how you explain what the template should be used for and can be as long as you need.</li><li>Visibility:&nbsp;Decides if only you or everyone can use this template.</li><li>File:&nbsp;This is the file that creates the template, needs to be .kml or .kmz.</li><li>Admin Level:&nbsp;What level of admin is required to use the template.</li><li>How many decimal places to round to:&nbsp;How accurate the borders on the regions are, the lower the rounding, the faster the template loads, but the less accurate it will be.</li><li>By default, what should the center point latitude be:&nbsp;This is the latitude for the template to focus on and first appear at.</li><li>By default, what should the center point longitude be:&nbsp;This is the longitude for the template to focus on and first appear at.</li>
<li>By default what should this map zoom to:&nbsp;This is how closs the template should zoom automatically, the small the number, the farther zoomed out the template is.</li></ol>',  '1',  '1'),
(NULL ,  '1',  'submenuhelp',  '<p><strong>This is the help page for creating submenus</strong><br /><br />This page should only be available to administrators of the website and is used to create submenus for any custom pages that you have made or any of the three default pages: <em>main,&nbsp;about,</em>&nbsp;and <em>support</em>.</p><p>Upon loading the page, you will see a table that holds the menus and their items.</p><table style="height: 131px; width: 746px; border: 1px solid #000000;" border="0"><thead><tr style="background-color: #d6d7d6;"><td><span style="font-size: small;"><strong>Submenu</strong></span></td><td><span style="font-size: small;"><strong>Items</strong></span></td><td><span style="font-size: small;"><strong>Actions</strong></span></td></tr></thead><tbody><tr align="left" valign="top"><td><span style="font-size: small;">This is the name of the menu that the corresponding items are in.</span></td><td><span style="font-size: small;">This is the representation of how the submenu will appear on the page. Clicking edit will open a pop up window allowing you to change its properties.</span></td><td><span style="font-size: small;">These are the actions that you can do on the menu. <strong>Delete</strong> will delete the menu and all the items it contains. <strong>Edit</strong> will allow you to change the name. And <strong>Add Item</strong> will allow you to put another item in the menu.</span></td></tr>
</tbody></table><p>&nbsp;</p><p>Below the table you will see options to create a new Menu.</p><p>&nbsp;</p><p><strong>Create a new menu.</strong></p><p>The menu just requires a title by which you will identify it. Hitting this save button will create the menu.</p><p>&nbsp;</p><p>The pop up page on hitting <strong>Add Item</strong> or<strong> Edit</strong> an item will show you this:</p><p><em>Title of menu item:</em> This is the text that will be displayed below the item, such as "Create submenus" located above.</p><p><em>Menu URL:&nbsp;</em>This is the name of the page that the menu item will link to when clicked on.</p><p><em>Icon (.jpeg, .png, .bmp):&nbsp;</em>Use this to upload an image file for the display of the menu item.</p><p><em>Only visible by Admins?</em>: This checkbox will say if the menu item will be seen by everyone or only by Admins, selected is for Admins only.</p><p>And hitting save here will save the menu item into the menu that was selected. You can also click delete to get rid of this item in the menu.</p>'
,  '1',  '1');
